...
import { MessageSquare, Calendar, MapPin, Search, CreditCard, Loader2 } from 'lucide-react';
            ...
            <div className="p-6 flex-1 flex flex-col justify-between">
              ...
              <div className="mt-6 pt-5 border-t border-gray-100 flex flex-wrap justify-between items-end gap-4">
                ...
                <div className="flex gap-3">
                  ...
                  {/* 2. Nút Thanh toán (Chỉ hiện khi PENDING) */}
                  {booking.status === 'PENDING' && (
                    ...
                    >
                      {processingId === booking.id ? <Loader2 className="animate-spin" size={16} /> : <CreditCard size={16} />}
                      Thanh toán
                    </button>
                  )}
