  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 relative -mt-32 z-10">
        ...
        <div className={`grid grid-cols-1 ${user.role === 'HOST' ? 'md:grid-cols-2' : ''} gap-8`}>
          {/* CỘT TRÁI: Hoạt động của tôi (ẩn với ADMIN) */}
          {user.role !== 'ADMIN' && (
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <Link href="/payments" className="group flex items-center justify-between p-5 hover:bg-purple-50 transition cursor-pointer">
                  <div className="flex items-center gap-4">
